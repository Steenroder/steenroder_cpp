...
namespace stn {
  ...
  public:
    ...
    void writeAnalysis(const unsigned int iteration, T* data) {
      STN_INSTRUMENT_ON("ScalarAnalysisWriter::writeAnalysis<NumberScalarAnalysis>", 3)
    ...
    void writeHeader(const std::string& header) {
      STN_INSTRUMENT_ON("ScalarAnalysisWriter::writeHeader", 2)
  ...
  public:
    ...
    void writeAnalysis(const unsigned int iteration,
      ...
      STN_INSTRUMENT_ON("SpectralAnalysisWriter::writeAnalysis<NumberComponents>",3)
    ...
    void writeHeader(const std::string& header) {
      STN_INSTRUMENT_ON("SpectralAnalysisWriter::writeHeader", 2)
  ...
  public:
    ...
    void writeField(Field<T, NumberComponents, architecture, true>& field) {
      STN_INSTRUMENT_ON("Writer<HDF5>::writeField<NumberComponents>",3)
  ...
  public:
    ...
    void write(const std::string& name, unsigned int numberComponents) {
      STN_INSTRUMENT_ON("Writer<XDMF>::writeField<NumberComponents>",3)
  ...
  private:
    ...
    void writeHeader() {
      STN_INSTRUMENT_ON("Writer<XDMF>::writeHeader",2)
    ...
    void writeFooter() {
      STN_INSTRUMENT_ON("Writer<XDMF>::writeFooter", 2)
